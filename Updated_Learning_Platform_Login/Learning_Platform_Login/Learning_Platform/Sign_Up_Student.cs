...
namespace Learning_Platform
{
    public partial class Sign_Up_Student : Form
    {
        public Sign_Up_Student()
        {
            ...
            cbm_type.Items.Add("Diploma in Computer Science");
            cbm_type.Items.Add("Diploma in Higher Mathematics");
            cbm_type.Items.Add("Diploma in Digital Marketing");
            cbm_type.Items.Add("Diploma in Business Adminstration");
            cbm_type.Items.Add("Higher Diploma in Computer Science");
        ...
        private void btn_create_Click(object sender, EventArgs e)
        {
            ...
            string course_name = cbm_type.SelectedItem.ToString();
            ...
            con.Open();
            cmd = new SqlCommand("Insert into Student values ('"+txt_fname.Text+"', '"+txt_lname.Text+"', '"+txt_mail.Text+ "','"+cbm_type.SelectedItem.ToString()+"', '" + txt_username.Text+"', '"+txt_pwd.Text+"', '"+txt_con_pwd.Text+"', '"+dobPicker.Value+"')", con);
        ...
        private void check_rules_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cbm_type.Enabled = !check_norms.Checked;
